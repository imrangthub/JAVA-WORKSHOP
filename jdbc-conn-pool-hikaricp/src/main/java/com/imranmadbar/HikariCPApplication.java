...
public class HikariCPApplication {
	...
	public static void main(String[] args) {
		...
		try (Connection connection = getConnection();
			...
			if (rs.next()) {
				System.out.println("Total Book are " + rs.getInt(1));
			}
